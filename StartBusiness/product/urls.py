...
urlpatterns = [
    ...
    path('productBulkPricing/update/<uuid:input>/',ProductBulkPricingView.as_view() ,name= "bulk pricing update" ),
    path('productTax/update/<uuid:input>/',ProductTaxInformationView.as_view(),name="tax information update"),
    ...
    path('productBulkPricing/view/',BulkPricingAllView.as_view() ,name= "get bulk pricing" ),
    path('productBulkPricing/view/<uuid:input>/',BulkPricingAllView.as_view() ,name= "get bulk pricing by id"),
    path('productTax/view/',ProductTaxAllView.as_view(),name="get all tax information "),
    path('productTax/view/<uuid:input>/',ProductTaxAllView.as_view(),name="get tax information by id "),
