...
class ProductCartSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ['product_id','name','image','length','length_unit','width','width_unit','thickness','thickness_unit','weight','weight_unit','price','discount','discount_price','status','category']