...
class Stock(models.Model):
    ...
    current_stock = models.PositiveBigIntegerField(blank=True)
    unit = models.PositiveBigIntegerField(blank=True)
    default_price = models.FloatField(blank=True)
    regular_selling_price = models.FloatField(blank=True)
    regular_buying_price = models.FloatField(blank=True)
